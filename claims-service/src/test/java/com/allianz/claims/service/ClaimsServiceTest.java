package com.allianz.claims.service;

import com.allianz.claims.domain.*;
import com.allianz.claims.dto.request.CreateClaimRequest;
import com.allianz.claims.dto.response.ClaimResponse;
import com.allianz.claims.exception.ClaimNotFoundException;
import com.allianz.claims.exception.InvalidClaimTransitionException;
import com.allianz.claims.pattern.factory.ClaimProcessor;
import com.allianz.claims.pattern.factory.ClaimProcessorFactory;
import com.allianz.claims.pattern.observer.ClaimEvent;
import com.allianz.claims.pattern.observer.ClaimEventPublisher;
import com.allianz.claims.pattern.strategy.NotificationResult;
import com.allianz.claims.pattern.strategy.NotificationStrategy;
import com.allianz.claims.repository.ClaimRepository;
...
class ClaimsServiceTest {
    ...
    class ApproveClaimTests {
        ...
        void shouldApproveClaimAndSendNotification() {
            ...
            // ACT
            ClaimResponse response = claimsService.approveClaim("CLAIM-001", "reviewer@allianz.com");
        ...
        void shouldThrowWhenClaimNotFound() {
            ...
            // ACT + ASSERT
            assertThatThrownBy(() -> claimsService.approveClaim("MISSING", "reviewer@allianz.com"))
        ...
        void shouldSucceedEvenWhenNotificationFails() {
            ...
            assertThatNoException().isThrownBy(
                () -> claimsService.approveClaim("CLAIM-001", "reviewer@allianz.com")
            );
    ...
    class RejectClaimTests {
        ...
        void shouldRejectSubmittedClaim() {
            ...
            // ACT
            claimsService.rejectClaim("CLAIM-001", "reviewer@allianz.com");
