...
class ClaimDomainTest {
    ...
    @BeforeEach
    void setUp() {
        holder = new PolicyHolder("Mohammad Zafar", "zafar@allianz.com",
    ...
    void shouldAllowSubmittedToUnderReview() {
        ...
        assertThatNoException().isThrownBy(() -> claim.startReview("reviewer@allianz.com"));
        assertThat(claim.getStatus()).isEqualTo(ClaimStatus.UNDER_REVIEW);
        assertThat(claim.getReviewedBy()).isEqualTo("reviewer@allianz.com");
    }
    ...
    void shouldAllowUnderReviewToApproved() {
        Claim claim = buildHomeClaim();
        claim.startReview("reviewer@allianz.com");
